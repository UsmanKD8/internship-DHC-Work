...
import { loadWallet } from '../../data/transactions';
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <Link to="/payments">
          <Card className="bg-primary-900 border border-primary-800 text-white h-full">
            <CardBody>
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-primary-200">Wallet Balance</p>
                  <h3 className="text-xl font-semibold">${walletBalance.toLocaleString()}</h3>
                </div>
              </div>
            </CardBody>
          </Card>
