...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    { to: '/messages', icon: <MessageCircle size={20} />, text: 'Messages', tourId: 'tour-messages' },
    { to: '/notifications', icon: <Bell size={20} />, text: 'Notifications' },
    { to: '/documents', icon: <FileText size={20} />, text: 'Documents', tourId: 'tour-documents' },
    { to: '/calendar', icon: <CalendarDays size={20} />, text: 'Calendar', tourId: 'tour-calendar' },
    { to: '/payments', icon: <Wallet size={20} />, text: 'Payments', tourId: 'tour-payments' },
  ];
  ...
  const investorItems = [
    ...
    { to: '/messages', icon: <MessageCircle size={20} />, text: 'Messages', tourId: 'tour-messages' },
    { to: '/notifications', icon: <Bell size={20} />, text: 'Notifications' },
    { to: '/deals', icon: <FileText size={20} />, text: 'Deals', tourId: 'tour-documents' },
    { to: '/calendar', icon: <CalendarDays size={20} />, text: 'Calendar', tourId: 'tour-calendar' },
    { to: '/payments', icon: <Wallet size={20} />, text: 'Payments', tourId: 'tour-payments' },
  ];
